    ...
    def __init__(self, name, *args, location=None, **op_attributes):
        ...
        class ExpandSub(ExpandTransformation):
            ...
            def expansion(node, state, sdfg):
                ...
                if input0_dim == 1 and input1_dim == 4:
                    ...
                    state_exp.add_edge(A, None, me, None,
        ...
        class ExpandIden(ExpandTransformation):
            ...
            def expansion(node, state, sdfg):
                ...
                if input_dim == 3 and output_dim == 3:
                    ...
                    tiden = state_exp.add_tasklet('tiden', {'_a'}, {'_b'},
                                                  '_b = _a')
        ...
        class ExpandTanh(ExpandTransformation):
            ...
            def expansion(node, state, sdfg):
                ...
                tmp_out = state_exp.add_transient('tmp_out', (ii, jj),
                                                  dace.float32)
                ...
                me3, mx3 = state_exp.add_map('map3',
                                             dict(i='0:' + I, j='0:' + J))
                state_exp.add_edge(
                    tmp_out, None, me3, None,
                    dace.Memlet.simple(tmp_out, '0:' + I + ', 0:' + J))
        ...
        class ExpandReduceSum(ExpandTransformation):
            ...
            def expansion(node, state, sdfg):
                ...
                me, mx = state_exp.add_map(
                    'outer_map', dict(i='0:' + M, k='0:' + G, l='0:' + H))

                data = state_exp.add_read('data')
                reduced = state_exp.add_access('reduced')

                redsum = state_exp.add_reduce('lambda a1, b1: a1 + b1', None,
                                              0)
                tmp_sum = state_exp.add_transient('tmp_sum', (1, ),
                                                  dace.float32)

                state_exp.add_edge(
                    data, None, me, None,
                    dace.Memlet.simple(
                        data, '0:' + M + ', 0:' + N + ', 0:' + G + ', 0:' + H))
                state_exp.add_edge(
                    me, None, redsum, None,
        ...
        class ExpandReduceMean(ExpandTransformation):
            ...
            def expansion(node, state, sdfg):
                ...
                if int(axes[0]) == 2:
                    ...
                    redsum = state_exp.add_reduce('lambda a1, b1: a1 + b1',
                                                  None, 0)
                    tmp_sum = state_exp.add_transient('tmp_sum', (1, ),
                                                      dace.float32)

                    tmean = state_exp.add_tasklet('meantasklet', {'tsum'},
                                                  {'mean'},
                                                  'mean = tsum / (%s)' % G)

                    state_exp.add_edge(
                        data, None, me, None,
                        dace.Memlet.simple(data,
                                           '0:' + M + ', 0:' + N + ', 0:' + G))
                    state_exp.add_edge(
                        me, None, redsum, None,
        ...
        class ExpandSoftmax(ExpandTransformation):
            ...
            def expansion(node, state, sdfg):
                ...
                state_exp = sdfg_exp.add_state()
                ome, omx = state_exp.add_map(
                    'outer_map', dict(i='0:' + I, j='0:' + J, k='0:' + K))
                ...
                tmp_max = state_exp.add_transient('tmp_max', (1, ),
                                                  dace.float32)
                tmp_sum = state_exp.add_transient('tmp_sum', (1, ),
                                                  dace.float32)
