...
def expansion(node, state, sdfg):
    ...
    if input0_dim == 4 and input1_dim == 1:
        ...
        me, mx = state_exp.add_map(
            'outer_map', dict(i='0:' + M, j='0:' + N, k='0:' + G, l='0:' + H))
        ...
        state_exp.add_edge(
            A, None, me, None,
            dace.Memlet.simple(A, '0:' + M + ', 0:' + N + ', 0:' + G + ', 0:' +
                               H))
        ...
        state_exp.add_edge(
            mx, None, C, None,
            dace.Memlet.simple(C, '0:' + M + ', 0:' + N + ', 0:' + G + ', 0:' +
                               H))
...
def expansion(node, state, sdfg):
    ...
    if input0_dim == 1 and input1_dim == 4:
        ...
        state_exp.add_edge(
            B, None, me, None,
            dace.Memlet.simple(B, '0:' + M + ', 0:' + N + ', 0:' + G + ', 0:' +
                               H))
...
@register_pure_expansion("Identity")
def expansion(node, state, sdfg):
    node.validate(sdfg, state)
...
@register_pure_expansion("ReduceSum")
def expansion(node, state, sdfg):
    node.validate(sdfg, state)
